var ClassifiedController = function () {
    ...
    function registerEvents() {
        ...
        $('body').on('click', '.btn-edit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#txtPrice').prop(data.Price);
                    $('#txtFront').prop(data.Front);
                    $('#txtWayIn').prop(data.WayIn);
                    $('#txtMainDirection').prop(data.MainDirection);
                    $('#txtBalconyDirection').prop(data.BalconyDirection);
                    $('#txtFloor').prop(data.Floor);
                    $('#txtBedRoom').prop(data.BedRoom);
                    $('#txtFurniture').prop(data.Furniture);
                    $('#txtLatitude').prop(data.Latitude);
        ...
        $('#btnSaveM').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                var front = $('#txtFront').val();
                var wayIn = $('#txtWayIn').val();
                var mainDirection = $('#txtMainDirection').val();
                var balconyDirection = $('#txtBalconyDirection').val();
                var floor = $('#txtFloor').val();
                var bedRoom = $('#txtBedRoom').val();
                var furniture = $('#txtFurniture').val();
                var latitude = $('#txtLatitude').val();
                $.ajax({
                    type: "POST",
                    url: "/Admin/Classifieds/SaveEntity",
                    data: {
                        Id: id,
                        Title: title,
                        Image: image,
    ...
    function loadData(isPageChanged) {
        $.ajax({
            type: "GET",
            url: "/admin/Classifieds/GetAllPaging",
            data: {
